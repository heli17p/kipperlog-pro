...
export const MATERIAL_COLORS: Record<string, string> = {
  'Aushub': 'bg-amber-600',
  'Betonabbruch': 'bg-slate-500',
  'Bauschutt': 'bg-red-700',
  'BAUSCHUTT': 'bg-red-700',
  'Asphaltabbruch': 'bg-neutral-800',
  'Humus': 'bg-emerald-600',
  'Sonstiges': 'bg-blue-600'
};
